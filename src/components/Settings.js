...
const Setting = () => {
  ...
  return (
    <div className="p-4 bg-[#F5F7FB] dark:bg-[#303841] dark:text-white rounded-lg shadow-md w-full h-screen ">
      {/* Settings Header */}
      <h1 className="text-lg md:text-xl font-semibold text-gray-700 dark:text-white text-center md:text-left">Settings</h1>
      ...
      <div className="flex flex-col md:flex-row items-center mt-4 md:space-x-4">
        ...
        <div className="flex flex-col items-center md:items-start mt-4 md:mt-0">
          ...
          <span className="text-gray-500 text-sm md:text-base cursor-pointer dark:text-white">Available ▼</span>
        </div>
      </div>
      ...
      <div className="mt-6 ">
        ...
        >
          <span className="dark:text-white text-gray-700 font-medium">Personal Info</span>
      ...
      <div className="mt-4">
        ...
        >
          <span className="dark:text-white text-gray-700 font-medium">Privacy</span>
      ...
      <div className=" mt-4">
        ...
        >
          <span className="dark:text-white text-gray-700 font-medium">Security</span>
      ...
      <div className="mt-4">
        ...
        >
          <span className="dark:text-white text-gray-700 font-medium">Help</span>
